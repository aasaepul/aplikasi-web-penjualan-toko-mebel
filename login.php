				  ...
				  <div class="product-details">
				  	<div class="contact-form">
					    ...
					    <form method="post" action="contact-post.html">
					    	<div>
						    	<input name="userName" type="text" class="textbox textbox1" placeholder="Username..." onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Name...';}" >
						    	<input name="userEmail" type="text" class="textbox" placeholder="Password..." onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email...';}">
						    	<div class="clear"></div>
						    </div>
